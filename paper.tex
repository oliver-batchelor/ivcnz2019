...
Code for this paper can be found \href{https://github.com/saulzar/detection/tree/thesis}{here}, under the tag ``thesis'', with details surrounding the cropping procedure, default training and augmentation parameters etc.
